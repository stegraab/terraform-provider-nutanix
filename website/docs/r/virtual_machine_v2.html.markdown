...
* `vtpm_disk_id`: (Computed) Inventory identifier of the firmware disk that stores the VM's vTPM state. This identifier is not cryptographic proof of TPM possession.
